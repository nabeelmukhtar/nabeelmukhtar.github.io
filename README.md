...
#### Areas of Expertise
Machine Learning, Software Architecture, Text Analysis, Natural Language Processing, Probabilistic Robotics, Rule Engines.
#### Programming Languages
Java, Python, R, C/C++, Octave.
#### Libraries/Frameworks
Spring, Hibernat, JEE, scikit-learn, TensorFlow, nltk, Hadoop, Lucene, Drools, OpenNLP, Spark, UIMA.
#### Platforms
JBoss, Tomcat, Liferay, WebSphere, Azure ML, Amazon EC2, Google AppEngine.
#### Databases
Oracle, SQL Server, MySQL, MongoDB, Redis, Elasticsearch, Neo4J, BigTable, HBase.
...
#### List of Projects
##### [Elastica](http://www.elastica.net)
...
1995 - 1999	N.E.D. University of Eng. & Tech.	Karachi
Passed with 83% marks.


#### Certificate of Specialization in Data Mining
2015 - Present	University of Illinois at Urbana-Champaign.	Online
In progress.
